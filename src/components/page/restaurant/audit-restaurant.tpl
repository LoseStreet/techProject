<div class="com_right_box">
  ...
  <div class="com_top_oper_box">
    <router-link :to="{ name: 'restaurant'}" class="com_btn com_back_btn"><span>返回</span></router-link>
  </div>
  ...
  <div class="com_con_center accept_box">
    <dl class="dl_form">
      <dd class="clearfix">
        ...
        <el-input v-model="mobile" @keyup.enter="acceptRestaurant" placeholder="请输入手机号"></el-input>
      </dd>
      <dd class="clearfix">
        <span class="name">短信验证码</span>
        <el-input v-model="code" class="password" @keyup.enter="acceptRestaurant" placeholder="请输入验证码"></el-input>
  ...
  <div class="com_con_bottom">
    <el-button @click="acceptRestaurant" class="com_btn reset_com_btn1 accept_btn">转让</el-button>
  </div>
