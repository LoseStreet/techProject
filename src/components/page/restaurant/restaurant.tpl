  ...
  <div class="restaurant_list_box">
    ...
    <div class="com_table_box role_mana_list_box">
      ...
      <div class="com_table_con">
        ...
        <template v-if="restaurantList && restaurantList.length > 0">
          <div class="tab_row clearfix" v-for="item in restaurantList">
            ...
            <span class="tab_cell tab_oper">
              ...
              <i class="check_claim_btn">
                <router-link :to="{ name: 'auditRestaurant', query: { 'restaurantId': item.id}}">认领</router-link>
              </i>
            </span>
          </div>

          <!-- <el-pagination
            v-if="restaurantList && restaurantList.totalPage > 1"
            @current-change="handleCurrentChange"
            :current-page.sync="restaurantList.pageNum"
            :page-size="restaurantList.pageSize"
            layout="prev, pager, next, jumper"
            :total="restaurantList.totalPage">
          </el-pagination> -->
        </template>
